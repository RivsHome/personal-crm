CREATE TABLE IF NOT EXISTS gym_routines (
  ...
  schedule_mode VARCHAR(20) NOT NULL DEFAULT 'rotation',
  day_workouts JSONB NOT NULL DEFAULT '{}',
...
ALTER TABLE gym_routines ADD COLUMN IF NOT EXISTS schedule_mode VARCHAR(20) NOT NULL DEFAULT 'rotation';
ALTER TABLE gym_routines ADD COLUMN IF NOT EXISTS day_workouts JSONB NOT NULL DEFAULT '{}';
