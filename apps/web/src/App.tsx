...
function TaskTree({ tasks, onToggle, onDelete, onAddSubtask, onEdit, subtaskParentId, subtaskSummary, saving, onSubtaskSummaryChange, onCreateSubtask, onCancelSubtask }: { tasks: Task[]; onToggle: (id: string) => void; onDelete: (id: string) => void; onAddSubtask: (id: string) => void; onEdit: (task: Task) => void; subtaskParentId: string | null; subtaskSummary: string; saving: boolean; onSubtaskSummaryChange: (value: string) => void; onCreateSubtask: (event: React.FormEvent) => void; onCancelSubtask: () => void }) {
