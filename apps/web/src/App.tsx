...
import { ArrowDown, ArrowLeft, ArrowRight, ArrowUp, CalendarDays, CheckSquare, ChevronDown, ChevronRight, CircleUserRound, Clapperboard, Download, GripVertical, LayoutDashboard, LogOut, Music2, Pencil, Plus, Search, Settings, Sparkles, Target, Trash2, WalletCards } from 'lucide-react'
import './module.css'
...
type View = 'dashboard' | 'calendar' | 'tasks' | 'ideas' | 'finance' | 'goals' | 'movies' | 'music' | 'memories' | 'settings'
...
function App() {
  ...
  const navSections: Array<{ label: string; items: Array<{ id: View; label: string; icon: typeof LayoutDashboard; enabled?: boolean }> }> = [
    ...
    { label: 'Life', items: [{ id: 'goals', label: 'Goals', icon: Target }, { id: 'memories', label: 'Memories', icon: CircleUserRound }] },
